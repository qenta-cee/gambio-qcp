...
$supportMails = array ("support.at@wirecard.com", "support.de@wirecard.com");
...
if(isset($_POST['submit'])) {
    if(!empty($_POST['wcp_config_export_reply_to_mail']) && !filter_var($_POST['wcp_config_export_reply_to_mail'], FILTER_VALIDATE_EMAIL)) {
        $message['ERROR'] = wcp_core::constant("MODULE_PAYMENT_WCP_EXPORT_CONFIG_INVALID_MAIL");
    }
    ...
    if(empty($message['ERROR'])) {
        if(mail($_POST['wcp_config_export_receiver'], 'WCP Config Export', $email, implode("\r\n", $headers))) {
            $message['OK'] = wcp_core::constant("MODULE_PAYMENT_WCP_EXPORT_CONFIG_MAIL_SENT");
            unset($_POST);
        }
        else {
            $message['ERROR'] = wcp_core::constant("MODULE_PAYMENT_WCP_EXPORT_CONFIG_MAIL_NOT_SENT");
        }
    }
}
    ...
    <head>
        ...
        <title><?php echo wcp_core::constant("MODULE_PAYMENT_WCP_EXPORT_CONFIG_LABEL"); ?></title>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:5px">
                        ...
                        <tr class="dataTableHeadingRow">
                            <td class="dataTableHeadingContentText"
                                style="border-right: 0px"><?php echo wcp_core::constant("MODULE_PAYMENT_WCP_EXPORT_CONFIG_LABEL"); ?></td>
                        </tr>
                        </tbody>
                    </table>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border: 1px solid #dddddd">
                        ...
                        <tr class="dataTableRow">
                            <td style="font-size: 12px; padding: 0px 10px 11px 10px; text-align: justify"
                                ...
                                <?php echo wcp_core::constant("MODULE_PAYMENT_WCP_EXPORT_CONFIG_DESC"); ?>
                                <br>
                                <br>

                                <form method="post" action="<?php echo PAGE_URL; ?>?pm=<?php echo $c; ?>" name="wcp_config_export_form">
                                    <label
                                        for="wcp_config_export_receiver" style="display:block"><strong><?php echo wcp_core::constant("MODULE_PAYMENT_WCP_EXPORT_CONFIG_RECEIVER"); ?></strong></label>
                                    ...
                                    <br>
                                    <label
                                        for="wcp_config_export_config_string" style="display:block"><strong><?php echo wcp_core::constant("MODULE_PAYMENT_WCP_EXPORT_CONFIG_CONFIG_STRING"); ?></strong></label>
                                    ...
                                    <br>
                                    <label
                                        for="wcp_config_export_description_text" style="display:block"><strong><?php echo wcp_core::constant("MODULE_PAYMENT_WCP_EXPORT_CONFIG_DESC_TEXT"); ?></strong></label>
                                    ...
                                    <br>
                                    <label
                                        for="wcp_config_export_reply_to_mail" style="display:block"><strong><?php echo wcp_core::constant("MODULE_PAYMENT_WCP_EXPORT_CONFIG_RETURN_MAIL"); ?></strong></label>
                                    <input type="text"
                                    ...
                                    <input class="button" type="submit"
                                           value="<?php echo wcp_core::constant("MODULE_PAYMENT_WCP_EXPORT_CONFIG_SUBMIT_BUTTON"); ?>"
                                           onclick="this.blur();" name="submit" style="margin-left:1px">
                                    <a href="<?php echo PAGE_BACK_URL; ?>" class="button" style="float:left;margin-left:1px"><?php echo wcp_core::constant("MODULE_PAYMENT_WCP_EXPORT_CONFIG_BACK_BUTTON");?></a>
                                </form>
                            </td>
                        </tr>
                        </tbody>
