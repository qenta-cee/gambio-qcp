...
(
	...
	'MODULE_PAYMENT_WCP_INVOICE_TEXT_DESCRIPTION' => 'You will be redirected to the Wirecard payment page when you place an order.',
	...
	'MODULE_PAYMENT_WCP_INVOICE_EMPTY_BIRTHDAY_ERROR' => 'Please enter a valid birthday date.',
	'MODULE_PAYMENT_WCP_INVOICE_PAYOLUTION_ERROR' => 'Please accept the payolution terms.',
	...
	'MODULE_PAYMENT_WCP_INVOICE_SEND_BASKET_TITLE' => 'Forward basket data',
	'MODULE_PAYMENT_WCP_INVOICE_SEND_BASKET_DESC' => 'Forwarding basket data to the respective financial service provider.',

	'MODULE_PAYMENT_WCP_INVOICE_SEND_SHIPPING_DATA_TITLE' => 'Forward consumer shipping data',
	'MODULE_PAYMENT_WCP_INVOICE_SEND_SHIPPING_DATA_DESC' => 'Forwarding shipping data about your consumer to the respective financial service provider.',

	'MODULE_PAYMENT_WCP_INVOICE_SEND_BILLING_DATA_TITLE' => 'Forward consumer billing data',
	'MODULE_PAYMENT_WCP_INVOICE_SEND_BILLING_DATA_DESC' => 'Forwarding billing data about your consumer to the respective financial service provider.',
);