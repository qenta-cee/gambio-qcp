...
define('MODULE_PAYMENT_WCP_SKRILLDIRECT_ORDER_STATUS_ID_TITLE', 'Order status');
define('MODULE_PAYMENT_WCP_SKRILLDIRECT_ORDER_STATUS_ID_DESC', 'Order status after successful payment with this module.');
