...
define('MODULE_PAYMENT_WCP_BMC_SEND_BASKET_TITLE', 'Forward basket data');
define('MODULE_PAYMENT_WCP_BMC_SEND_BASKET_DESC', 'Forwarding basket data to the respective financial service provider.');

define('MODULE_PAYMENT_WCP_BMC_SEND_SHIPPING_DATA_TITLE', 'Forward consumer shipping data');
define('MODULE_PAYMENT_WCP_BMC_SEND_SHIPPING_DATA_DESC', 'Forwarding shipping data about your consumer to the respective financial service provider.');

define('MODULE_PAYMENT_WCP_BMC_SEND_BILLING_DATA_TITLE', 'Forward consumer billing data');
define('MODULE_PAYMENT_WCP_BMC_SEND_BILLING_DATA_DESC', 'Forwarding billing data about your consumer to the respective financial service provider.');
