...
define('MODULE_PAYMENT_WCP_BMC_PLUGIN_MODE_TITLE', 'Plug-In Modus');
define('MODULE_PAYMENT_WCP_BMC_PLUGIN_MODE_DESC', 'Wechseln Sie zwischen Live, Demo oder Test Modus. <strong>Achtung</strong>: Es werden keine Transaktionen im Demo oder Test Modus verarbeitet!');

define('MODULE_PAYMENT_WCP_BMC_ORDER_STATUS_ID_TITLE', 'Bestellstatus festlegen');
define('MODULE_PAYMENT_WCP_BMC_ORDER_STATUS_ID_DESC', 'Bestellungen, die mit diesem Modul gemacht werden, auf diesen Status setzen');

define('MODULE_PAYMENT_WCP_BMC_PRESHARED_KEY_TITLE', 'Geheimer Schl&uuml;ssel (SECRET)');
define('MODULE_PAYMENT_WCP_BMC_PRESHARED_KEY_DESC', 'Vorher vereinbarter geheimer Schl&uuml;ssel');

define('MODULE_PAYMENT_WCP_BMC_CUSTOMER_ID_TITLE', 'Kundennummer');
define('MODULE_PAYMENT_WCP_BMC_CUSTOMER_ID_DESC', '');

define('MODULE_PAYMENT_WCP_BMC_LOGO_TITLE', 'Shop-Logo URL inkludieren');
...
define('MODULE_PAYMENT_WCP_BMC_DUPLICATE_REQUEST_CHECK_TITLE', 'Aktiviere Duplicate-Request-Check');
define('MODULE_PAYMENT_WCP_BMC_DUPLICATE_REQUEST_CHECK_DESC', '');

define('MODULE_PAYMENT_WCP_BMC_STATEMENT_TITLE', 'Kunden Abrechnungstext Prefix');
define('MODULE_PAYMENT_WCP_BMC_STATEMENT_DESC', '');

define('MODULE_PAYMENT_WCP_BMC_DISPLAY_TEXT_TITLE', 'Anzeige Text');
define('MODULE_PAYMENT_WCP_BMC_DISPLAY_TEXT_DESC', '');

define('MODULE_PAYMENT_WCP_BMC_ORDER_DESCRIPTION_TITLE', 'Prefix f&uuml;r Bestellbeschreibung');
define('MODULE_PAYMENT_WCP_BMC_ORDER_DESCRIPTION_DESC', '');

define('MODULE_PAYMENT_WCP_BMC_USE_IFRAME_TITLE', 'IFrame verwenden?');
define('MODULE_PAYMENT_WCP_BMC_USE_IFRAME_DESC', '');

define('MODULE_PAYMENT_WCP_BMC_SORT_ORDER_TITLE', 'Anzeigeordnung');
define('MODULE_PAYMENT_WCP_BMC_SORT_ORDER_DESC', 'Niederste an erster Stelle');

define('MODULE_PAYMENT_WCP_BMC_ALLOWED_TITLE' , 'Erlaubte Zonen');
define('MODULE_PAYMENT_WCP_BMC_ALLOWED_DESC' , 'Geben Sie erlaubte Zonen ein (e.g. AT,DE)');

define('MODULE_PAYMENT_WCP_BMC_CHECKOUT_TITLE', 'Bezahlvorgang');
